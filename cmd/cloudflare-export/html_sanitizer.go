...
// sanitizeEntryContent matches the legacy reader boundary so migrated content
// remains safe when the React reader renders it as HTML.
...
func setHTMLNodeAttr(node *html.Node, key, value string) {
