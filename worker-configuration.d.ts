/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: f79f9cea2ea7febc96b7ddbfd8fd5285)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_ENVIRONMENT" | "AUTH_ORIGIN" | "AUTH_RP_NAME" | "AUTH_CHALLENGE_TTL_SECONDS" | "AUTH_SESSION_TTL_SECONDS" | "TURNSTILE_ENABLED" | "AI_SUMMARY_ENABLED" | "AI_GATEWAY_NAME" | "AI_MODEL" | "REFRESH_SCHEDULER_ENABLED" | "REFRESH_DISPATCH_ENABLED" | "REFRESH_DUE_LIMIT" | "OPML_IMPORT_ENABLED" | "FAVICON_REFRESH_ENABLED" | "IMAGES_ENABLED" | "FEED_REFRESH_QUEUE_NAME" | "OPML_IMPORT_QUEUE_NAME" | "FAVICON_REFRESH_QUEUE_NAME" | "AUTH_OPERATOR_SECRET">> {}
}
