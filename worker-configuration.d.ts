/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: 9e92329ae5d072b92587cf4cc358082b)
// Runtime types generated with workerd@1.20260801.1 2026-07-18 nodejs_compat
interface __BaseEnv_Env {
	FULL_CONTENT_KV: KVNamespace;
	DB: D1Database;
	FEED_REFRESH_QUEUE: Queue;
	OPML_IMPORT_QUEUE: Queue;
	FAVICON_REFRESH_QUEUE: Queue;
	AUTH_RATE_LIMITER: RateLimit;
	COMPAT_RATE_LIMITER: RateLimit;
	AI?: Ai;
	...
	AI_MODEL: string;
	FULL_CONTENT_ENABLED: string;
	REFRESH_SCHEDULER_ENABLED: string;
	REFRESH_DISPATCH_ENABLED: string;
	REFRESH_DUE_LIMIT: string;
	OPML_IMPORT_ENABLED: string;
	FAVICON_REFRESH_ENABLED: string;
	IMAGES_ENABLED: string;
	FEED_REFRESH_QUEUE_NAME: string;
	OPML_IMPORT_QUEUE_NAME: string;
	FAVICON_REFRESH_QUEUE_NAME: string;
	AUTH_OPERATOR_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_ENVIRONMENT" | "AUTH_ORIGIN" | "AUTH_RP_NAME" | "AUTH_CHALLENGE_TTL_SECONDS" | "AUTH_SESSION_TTL_SECONDS" | "TURNSTILE_ENABLED" | "AI_SUMMARY_ENABLED" | "AI_GATEWAY_NAME" | "AI_MODEL" | "FULL_CONTENT_ENABLED" | "REFRESH_SCHEDULER_ENABLED" | "REFRESH_DISPATCH_ENABLED" | "REFRESH_DUE_LIMIT" | "OPML_IMPORT_ENABLED" | "FAVICON_REFRESH_ENABLED" | "IMAGES_ENABLED" | "FEED_REFRESH_QUEUE_NAME" | "OPML_IMPORT_QUEUE_NAME" | "FAVICON_REFRESH_QUEUE_NAME" | "AUTH_OPERATOR_SECRET">> {}
}
